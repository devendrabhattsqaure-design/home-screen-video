...
const features = [
  {
    ...
    title: "100% Authentic",
    description:
      "Every product is sourced directly from trusted artisans and suppliers across India.",
  },
  {
    icon: Sparkles,
    title: "Premium Quality",
    description:
      "Handpicked items crafted with devotion and the finest natural materials.",
  },
  {
    icon: Truck,
    title: "Pan-India Delivery",
    description:
      "Fast and secure shipping to your doorstep, from Varanasi to every corner of India.",
  },
  {
    icon: HandHeart,
    title: "Made with Devotion",
    description:
      "Each product carries the blessings and dedication of skilled temple artisans.",
  },
]
    ...
    <>
      ...
      >
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link
            href="/products"
            className="rounded-xl mt-10 border-2 border-[var(--color-sandal)] bg-primary px-8 py-3.5 font-semibold text-primary-foreground shadow-sm transition-all hover:bg-primary/90 hover:shadow-md"
          >
            Explore Products
          </Link>
          <Link
        ...
        <div className="mx-auto max-w-7xl px-6">
          <AnimatedSection className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-muted-foreground leading-relaxed">
              Discover our handpicked selection of premium pooja essentials, crafted with devotion and tradition.
            </p>
          </AnimatedSection>
      ...
      <section className="bg-background py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-6">
          <AnimatedSection className="text-center">
            ...
            <h2 className="mt-3 font-serif text-3xl font-bold text-foreground md:text-4xl text-balance">
              Blessed Words from Our Devotees
            </h2>
          </AnimatedSection>
      ...
      <section className="bg-secondary py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-6">
          <AnimatedSection className="text-center">
            <h2 className="font-serif text-3xl font-bold text-[var(--color-sandal)] md:text-4xl text-balance">
              Begin Your Sacred Journey Today
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-secondary-foreground/80 leading-relaxed">
              Explore our complete collection of authentic pooja samagri and bring divine blessings to your home.
            </p>
