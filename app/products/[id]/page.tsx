            ...
            <AnimatedSection delay={150}>
              <div>
                ...
                <div className="mt-10 flex flex-col gap-3 sm:flex-row">
                  <button className="rounded-xl bg-primary px-8 py-3.5 font-semibold text-primary-foreground shadow-sm transition-all hover:bg-primary/90 hover:shadow-md active:scale-95">
                    Add to Cart
                  </button>
                  <a
